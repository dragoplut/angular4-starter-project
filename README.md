...
> Based on: Angular 2 starter kit [angular2-webpack-starter](https://github.com/AngularClass/angular2-webpack-starter.git),
...
# use Hot Module Replacement. Recommended on dev stage
...
* Ensure you're running the latest versions Node `v7.x.x`+ and NPM `4.x.x`+
